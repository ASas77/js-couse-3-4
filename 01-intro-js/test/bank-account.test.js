...
describe('Bank account', function () {
    ...
    it('should be able to not let get more money from bank account than user has', function () {
        var BankAccount = getNewBankAccount();
        BankAccount.deposit(100);
        // BankAccount.withdraw.apply

        /*var BankAccount = getNewBankAccount();
        var newAccount = Object.assign({}, BankAccount, {balance: 10000});
        BankAccount.widthraw.apply(newAccount, [50]);
